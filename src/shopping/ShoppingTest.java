...
public class ShoppingTest extends Utility {
    ...
    public void verifyThatUserShouldPlaceOrderSuccessfullyForCupOfMojoBluetoothSpeaker() throws InterruptedException {
       ...
       driver.findElement(By.xpath("(//div[@title='Your cart'])[1]")).click();
        ...
        Thread.sleep(2000);
        sendDataOnElement(By.xpath("//input[@id=\"shippingaddress-firstname\"]"),"lauren");
        sendDataOnElement(By.xpath("//input[@id=\"shippingaddress-lastname\"]"),"peterson");
        sendDataOnElement(By.xpath("//input[@id=\"shippingaddress-street\"]"),"Thoreparch road ");
        ...
        sendDataOnElement(By.xpath("//input[@id=\"shippingaddress-zipcode\"]"),"40001");
        clickOnElement(By.xpath("//input[@id=\"create_profile\"]"));
        sendDataOnElement(By.xpath("//input[@id=\"password\"]"),"qwer1234");
        Thread.sleep(2000);
